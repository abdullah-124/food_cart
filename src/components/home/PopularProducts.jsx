    ...
    <div className='min-h-[600px] lg:w-3/4 m-auto py-20 '>
      ...
      <div className='mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4'>
        <div className='popular_card'>
          <img src='/assets/items/item1.png' alt='Popular Food Item' className='w-full max-h-[200px] object-cover' />
        ...
        <div className='popular_card'>
          <img src='/assets/items/item2.png' alt='Popular Food Item' className='w-full max-h-[200px] object-cover' />
          <div className='text-center font-semibold py-2'>
        ...
        <div className='popular_card'>
          <img src='/assets/items/item3.png' alt='Popular Food Item' className='w-full max-h-[200px] object-cover' />
          <div className='text-center font-semibold py-2'>
        ...
        <div className='popular_card'>
          <img src='/assets/items/item4.png' alt='Popular Food Item' className='w-full max-h-[200px] object-cover' />
          <div className='text-center font-semibold py-2'>
