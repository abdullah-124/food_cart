...
function DiscountSection() {
    return (
        <div className='min-h-[300px] lg:w-3/4 m-auto py-5 relative'>
            <img src="/src/assets/bg4.png" alt="background" className='rounded-lg -z-1 absolute inset-0 w-full h-full object-cover' />
            <div className="flex items-center justify-center">
                <div className='z-1 text-white ps-5 md:ps-10 w-full'>
                    ...
                    <p>Big Size <span className='text-yellow-500'>Burger $59,00</span></p>
                    <button className='btn_border mt-5 flex items-center gap-2'><CiDeliveryTruck /> Order Now</button>
                </div>
                <div className='w-full'>
                    <img src="/src/assets/chicken_discount.png" alt="chicken" />
                </div>
            </div>
        </div>
    )
